...
env_instructions_path = os.path.join(os.path.dirname(__file__),'.env.instructions')

load_dotenv(env_instructions_path)
...
def get_audio_from_video() -> None :
    print("file_path",file_path,os.getenv('file_path'))
